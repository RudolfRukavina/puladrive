<template>
  ...
  <Head>
    <Title>Cijene organiziranih putovanja | Cjenik 2024. | Taxi Opatija | 0 - 24 | Taxi | Rent a car | Rent a Van |
      Transfers |
      Excursions
    </Title>
    <Meta name="description"
      content="Cijene organiziranih putovanja | Cjenik 2024 | Pozovi taxi | Taxi Opatija | Best service at the best price | Available 24 hours every day | Taxi | Rent a car | Rent a Van | Transfers | Excursions & more" />
  </Head>
        ...
        <div class="mx-auto max-w-2xl pt-10">
          ...
          <div class="text-center">
            ...
            <h2 class="text-base font-bold tracking-tight text-gray-900">
              Cjenik 2024. - Cijene organiziranih putovanja
            </h2>
