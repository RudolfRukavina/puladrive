  ...
  <main>
    ...
    <div class="flex justify-center w-full overflow-x-auto pb-4">
      <div
        ...
        <p class="absolute top-0 right-0 p-2">
          <span class="whitespace-nowrap rounded-full bg-green-400 px-2.5 py-0.5 text-xs text-black">
            {{ currentTime }}
          </span>
        </p>

        <h3 class="text-xl text-gray-900 mb-4">
          Taxi - Dnevna vožnja <br />
          <span class="font-bold">05:00 - 22:00</span>
        </h3>
      ...
      <div class="border mx-5 min-w-[320px] max-w-lg mt-10 border-black custom-shadow rounded-lg p-6 relative bg-white">
        <p class="absolute top-0 right-0 p-2">
          <span class="whitespace-nowrap rounded-full bg-red-400 px-2.5 py-0.5 text-xs text-black">
            {{ currentTime }}
          </span>
        </p>

        <h3 class="text-xl text-gray-900 mb-4">
          Taxi - Noćna vožnja <br />
          <span class="font-bold">22:00 - 05:00</span>
        </h3>
        <ul class="list-disc list-inside text-gray-700">
          <li class="mb-2">Početna naknada: 4.00€</li>
    ...
    <div class="flex items-center justify-center border-b"></div>
    <div class="flex justify-center w-full mb-10">
      <div class="border mx-5 max-w-lg mt-10 border-black custom-shadow rounded-lg p-6 relative bg-white pl-10 ">
        <svg class='w-8 mb-4 bg-red-600 rounded-tl-md rounded-br-lg p-[3px] m-1 absolute top-0 left-0'
        ...
        <h3 class="text-3xl inline-block text-gray-900 mb-2 drop-shadow-md" :class='selectedTransfer.transferTitle ?
              "text-2xl" :
              "text-3xl"'>{{ selectedTransfer.transferTitle ?
              selectedTransfer.transferTitle :
              "Transferi" }}</h3>
        <p class="text-gray-500 text-sm pb-3">
          {{ selectedTransfer.transferSubtitle ? selectedTransfer.transferSubtitle :
        ...
        <div v-if='selectedTransfer' class=" max-w-lg    rounded-lg relative bg-white">
          <div class="mt-[15px] flex justify-between">
            ...
            <div>
              <h3 class="text-2xl font-semibold text-gray-900">1 - 4 putnika</h3>
              <span class="text-4xl font-bold tracking-tight text-gray-900">{{ selectedTransfer.autoCijena }}€</span>
            </div>
          ...
          <div class='flex justify-between'>
            ...
            <div>
              <h3 class="text-2xl font-semibold text-gray-900">5 - 8 putnika</h3>
              <span class="text-4xl font-bold tracking-tight text-gray-900">{{ selectedTransfer.kombiCijena }}€</span>
            </div>
          </div>
        </div>
        <div v-else>
          ...
          <div class="grid grid-cols-2 gap-4">
            <span v-for="transfer in transfersData" @click="selectedTransfer = transfer"
              class=" whitespace-nowrap rounded-full bg-sky-100 px-2.5 py-0.5 text-base text-center text-blue-600">
              {{ transfer.name }}
            </span>
          </div>
        </div>
