<template>
  ...
  <Head>
    <Title>Naslovnica | Taxi Opatija | 0 - 24 | Taxi | Rent a car | Rent a Van |
            ...
            <div class="mt-10 flex items-center justify-evenly gap-x-2">
              ...
              <a id="callLink2" href="tel:+38598491369" class="inline-block w-50">
                <button
                  ...
                  <svg class='inline-block w-14' version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g id="SVGRepo_iconCarrier">
                      <g>
                        <path class="st0"
                          d="M96.658,148.337l-21.936-8.261c-20.049-7.552-42.424,2.583-49.975,22.616 c-7.552,20.053,2.588,42.413,22.635,49.965l49.276,18.575V148.337z">
                        </path>
                        <path class="st0"
                        ...
                        <path class="st0"
                          d="M109.165,312.015c3.446,1.322,6.955,1.913,10.4,1.913c5.955,0,11.776-1.814,16.637-5.128 c4.86-3.312,8.765-8.054,10.997-13.98c1.302-3.471,1.903-6.971,1.903-10.43c0.01-5.935-1.818-11.752-5.116-16.622 c-3.312-4.861-8.069-8.755-14.01-11.003L99.399,245.25c-3.451-1.302-6.951-1.912-10.406-1.912c-5.954,0-11.762,1.823-16.626,5.146 c-4.861,3.293-8.765,8.055-11.013,14c-1.286,3.43-1.898,6.941-1.898,10.391c0,5.954,1.829,11.761,5.132,16.632 c3.308,4.861,8.065,8.765,14.006,11.012L109.165,312.015z">
                        </path>
                        <path class="st0"
                          d="M226.638,188.541l10.781-6.941c3.456-2.208,4.461-6.802,2.238-10.253l-15.247-23.78 c-2.213-3.45-6.808-4.436-10.263-2.237c-0.079,0.048-1.286,0.818-14.335,9.198c-15.203,9.76-7.034,51.572,14.665,85.398 c21.704,33.826,56.329,58.67,71.522,48.91c13.054-8.37,14.251-9.14,14.335-9.208c3.45-2.199,4.456-6.812,2.243-10.263 l-15.258-23.76c-2.208-3.451-6.807-4.456-10.263-2.228l-10.785,6.92c-3.145,2.011-7.31,1.371-9.711-1.488 c0,0-7.247-7.424-18.067-24.293c-10.815-16.848-14.552-26.55-14.552-26.55C222.335,194.595,223.494,190.553,226.638,188.541z">
                        </path>
                      </g>
                    </g>
                  </svg>
