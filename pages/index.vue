<template>
  ...
  <main id="home">
    ...
    <div
      class="overflow-x-auto text-nowrap whitespace-nowrap sticky top-0 mt-3 w-full z-50 bg-white text-gray-800 drop-shadow-md shadow-sm"
      id="start">
        ...
        <div class="flex items-center justify-evenly">
          <ul class="grid grid-cols-3 font-medium mt-0 text-[16px]">
            <li class="border-e px-4 w-full text-center">
              <NuxtLink :to="{ path: '/', hash: '#home' }" class="hover:underline">{{ $t("home") }}
              </NuxtLink>
            </li>
            <li class="px-4 w-full text-center border-gray-300">
              <NuxtLink :to="{ path: '/', hash: '#prices' }" class="hover:underline">Prices
              </NuxtLink>
            </li>
            <li class="border-s px-4 w-full text-center">
              <NuxtLink :to="{ path: '/', hash: '#about-us' }" class="hover:underline">{{ $t("aboutus") }}
              </NuxtLink>
            </li>
          </ul>
        </div>
    ...
    <div>
      <div class="relative isolate px-6 lg:px-8 mt-[45px] pb-14">
    ...
    <div class="flex justify-center w-full bg-sky-500 py-5 mb-10 -mt-[1px]" id="prices">
      <div class="grid grid-cols-2 gap-6 max-w-md text-lg text-center">
        <NuxtLink :to="{ path: '/', hash: '#taxi-price' }"
          class="mx-auto cursor-pointer lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full py-3 px-6 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
          Taxi prices
        </NuxtLink>
        ...
        <NuxtLink :to="{ path: '/', hash: '#rent-a-van' }"
          class="mx-auto cursor-pointer lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full py-3 px-6 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
          Rent a van
        </NuxtLink>
        <NuxtLink :to="{ path: '/', hash: '#rent-a-car' }"
          class="mx-auto cursor-pointer lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full py-3 px-6 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
          Rent a car
        </NuxtLink>
      </div>
    ...
    <div class="leading-normal tracking-normal bg-sky-500" style="font-family: 'Source Sans Pro', sans-serif">
      <section>
        ...
        <Seperator />
        <article class="py-10 bg-sky-500" id="transfers">
          <h2 class="text-white my-3 font-bold drop-shadow-md text-5xl text-center">
                    ...
                    <article class="service-card bg-white rounded-xl shadow-md transition hover:shadow-lg">
                      <div class="p-6 w-80">
                        ...
                        <p class="text-gray-600">
                          ...
                          <strong>airports</strong>, <strong>cities</strong>,
                          and <strong>destinations</strong>.
                        </p>
                        ...
                        <p class="text-gray-600 my-3">
                          <strong>Scroll right</strong> to explore pricing
                          options.
                        </p>
                      </div>
                    </article>
          ...
          ">
                    ...
                    <article class="service-card bg-white rounded-xl shadow-md transition hover:shadow-lg">
                      ...
                      <div class="flex justify-center">
                        <span class="text-sm font-bold text-white bg-sky-500 rounded-xl p-2 m-2 text-center w-full">15%
                          discount</span>
                      </div>
                    </article>
                  </div>
        ...
        <Seperator />
        <article class="py-10 pb-16 bg-sky-500" id="rent-a-van">
          <h2 class="text-white my-3 font-bold drop-shadow-md text-5xl text-center">
          ...
          <div class="flex justify-center">
            <div class="service-card bg-white rounded-xl mx-5 max-w-lg shadow-md transition hover:shadow-lg">
        ...
        <Seperator />
        <article class="py-10 bg-sky-500" id="rent-a-car">
          <h2 class="text-white my-3 font-bold drop-shadow-md text-5xl text-center">
          ...
          <div class="flex justify-center">
            <div class="service-card bg-white rounded-xl mx-5 max-w-lg shadow-md mb-9 transition hover:shadow-lg">
              <NuxtLink :to="i18n.locale.value === 'en'
            ? '/en/rent-a-car'
            : '/najam-automobila'
          ">
            ...
            <div class="flex">
              ...
              <div
                ...
                <p class="text-xl text-start font-medium text-gray-700 drop-shadow-md">
                  Taxi Opatija is the official and most trusted taxi service in
                  Opatija.
                </p>
                <p class="text-xl text-start my-2 font-medium text-gray-500">
                  Whether you're looking for a quick taxi ride in Opatija or a
                  big trip anywhere across Europe, Taxi Opatija is your go-to
                  destination for exceptional service, ensuring prompt,
                  reliable, and comfortable transportation experiences.
                </p>
              </div>
              <div
                class="inline-block px-6 dark:ring-white/10 ring-primary/5 dark:shadow-thick rounded-3xl lg:row-start-4 h-full p-5 bg-white dark:bg-secondary">
                ...
                <p class="text-xl text-start my-2 font-medium text-gray-500">
                  Our vehicle fleet consists of modern vans (8+1) and
                  comfortable cars (3+1), equipped with all necessary amenities
                  to make your journey pleasant and stress-free.
                </p>
              </div>
              <div
                class="inline-block px-6 dark:ring-white/10 ring-primary/5 dark:shadow-thick rounded-3xl lg:row-start-4 h-full p-5 bg-white dark:bg-secondary">
