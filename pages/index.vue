        ...
        <div class="flex items-center justify-evenly">
          <ul class="grid grid-cols-3 font-medium mt-0 text-[16px]">
            ...
            <li class="px-4 w-full text-center border-gray-300">
              <NuxtLink :to="{ path: '/', hash: '#prices' }" class="hover:underline drop-shadow-md">{{ $t("prices") }}
              </NuxtLink>
            </li>
        ...
        <div class="text-center">
          ...
          <div class="text-lg flex justify-center font-medium tracking-tight px-8 text-black">
            <NuxtMarquee :pauseOnHover="true" :gradientWidth="130" class="rounded-[58px]" :gradient="true"
              ...
              -
              <span class="px-3">
                <strong>{{ $t('cityTransfers') }}</strong>
              </span>
              -
              <span class="px-3">
                <strong>{{ $t('excursions') }}</strong>
              </span>
              -
              <span class="px-3">
                <strong>{{ $t('rentCar') }}</strong>
              </span>
              -
              <span class="px-3">
                <strong>{{ $t('rentVan') }}</strong>
              </span>
              |
              <span class="px-3">
