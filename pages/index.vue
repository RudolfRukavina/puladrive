<template>
  ...
  <main id="home">
    ...
    <nav
      class="z-50 text-gray-200 bg-gradient-to-r from-[#e67930] to-[#f1ba5d] border-b border-black sticky -top-[1px] py-1 pt-[1px]"
    ></nav>
  ...
  <nav
    class="z-50 text-gray-200 bg-gradient-to-r from-[#e67930] to-[#f1ba5d] border-b border-black sticky -bottom-[1px] pt-[1px]"
  >
    <div class="max-w-screen-xl px-4 py-3 mx-auto">
      <div class="flex items-center">
        ...
        >
          <li>
            <a
              :href="`https://api.whatsapp.com/send?phone=385917865619&text=Poštovani%2C%20zainteresiran%2Fa%20sam%20za%20instrukcije%20na%20razini%20fakulteta.%20Molim%20vas%20za%20više%20informacija%20o%20slobodnim%20terminima.%20Hvala!`"
              target="_blank"
            >
              <svg
                class="w-8 hover:scale-125 transition duration-300"
              ...
              >
                <g id="SVGRepo_bgCarrier" stroke-width="0">
                  <path
                    transform="translate(-9.6, -9.6), scale(1.35)"
                    d="M16,26.156388751334614C18.687101367331806,26.614343774205455,20.21331139536915,30.76339727196256,22.906216517642438,30.34090636824581C25.222143908958927,29.977559643399566,25.19141499806184,26.328272431198354,26.64205190847477,24.48675320011383C28.082737045102988,22.657867304549995,30.888584389361284,21.78615394241107,31.429028111942568,19.521574982733068C31.96861166407676,17.260600327841733,29.93159674631462,15.204382520151496,29.39717365766991,12.942182537365227C28.867168339909174,10.698682871668606,29.52196456074041,8.148637536407229,28.283023882009186,6.204615319090637C27.0312581903908,4.240469369929563,24.845817873944746,2.9198081338607325,22.60499876789416,2.2845787341338664C20.45519582208786,1.6751506767292386,18.23442939054741,2.7421207368388316,16,2.722612748543421C13.743881700275512,2.702915402290154,11.239382521874163,0.9522640491629963,9.33922592154492,2.1687601083536325C7.360532433169627,3.435536136465019,8.187799510034406,6.765673259126176,6.764724071502108,8.635113208036692C5.386385702957002,10.44578377370389,1.9308224236095133,10.455836402853969,1.3549734002246083,12.657368246331098C0.7862577421071165,14.831628478414231,3.4856966852495477,16.556152421611475,4.1296362904054895,18.709333055352598C4.723165503099466,20.69395334598187,3.8709405376195134,23.038215008869688,4.98230924836953,24.78631518136107C6.099246112206508,26.543173643767958,8.075494509846369,27.90853679615819,10.141432560466875,28.165440641452538C12.216152871985603,28.42343657980091,13.939016864624381,25.805141273151623,16,26.156388751334614"
                    fill="#000000"
                    strokewidth="0"
                  ></path>
                </g>
