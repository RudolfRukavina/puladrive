            ...
            <div class="mt-10 flex items-center justify-evenly gap-x-2">
              ...
              <a id="callLink2" href="tel:+38598491369" class="inline-block w-50">
                <button
                  ...
                  <p class="inline-block">Pozovi prijevoz</p>
                </button>
              </a>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <article
              ...
              <NuxtLink to="/taxi-opatija-cijena">
                <div class="rounded-[10px] bg-white p-4 sm:p-6 h-full">
                  <div class="flex justify-between mt-1">
                    <span class="text-sm ms-8 w-full text-blue-800 text-center font-medium">Cjenik 2024. - Cijene taxi
                      službe</span>
                  ...
                  <h3 class="mt-0 text-3xl font-bold text-gray-800 drop-shadow-md py-1 text-center">
                    Taxi služba
                  </h3>
                  <p class="text-gray-500 text-sm border-b pb-3">
                    Profesionalna taxi usluga dostupna 24/7 za sve vaše
            ...
            <article
              ...
              <a href="tel:+38598491369">
                <div class="rounded-[10px] bg-white p-4 sm:p-6 h-full">
                  ...
                  <p class="text-gray-500 text-sm border-b pb-3">
                    Pružamo i širok spektar dodatnih usluga kako bismo
  ...
  <!-- <footer class="bg-white rounded-lg custom-shadow dark:bg-gray-900 w-full fixed bottom-0">
    <div class="w-full max-w-screen-xl mx-auto p-4 pb-0 md:py-4">
      <div class="sm:flex sm:items-center sm:justify-between">
        <a href="tel:+38598491369" class="flex justify-between items-center mb-3 sm:mb-0 space-x-3 rtl:space-x-reverse">
          <div class="flex justify-center">
      ...
      <div class="w-full flex flex-col md:flex-row py-6">
        ...
        <div class="flex-1">
          ...
          <ul class="list-reset mb-6">
            ...
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <NuxtLink to="/taxi-opatija-najam-kombi-vozila-cijena"
                class="no-underline hover:underline text-gray-800 hover:text-pink-500">Najam kombi vozila - Cjenik 2024.
              </NuxtLink>
            </li>
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <NuxtLink to="/taxi-opatija-najam-automobila-cijena"
...
.gradient {
  ...
  background: -webkit-linear-gradient(to top, #818181, #ffffff);
