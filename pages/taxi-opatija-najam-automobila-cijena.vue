<template>
  ...
  <Head>
    <Title>Najam automobila | Cjenik 2024. | Taxi Opatija | 0 - 24
    </Title>
    <Meta name="description"
      content="Najam automobila | Cjenik 2024 | Taxi Opatija | Best service at the best price | Available 24 hours every day | Taxi & more" />
  </Head>
        ...
        <div class="border mx-5 max-w-lg mt-10 border-black custom-shadow rounded-lg p-6 relative bg-white pl-10">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-gray-100 p-4 rounded-lg">
              <h3 class="text-lg font-semibold text-gray-900 mb-2">Za do 2 dana</h3>
              <span class="text-xl font-bold text-gray-900">60 - 80€ / dan</span>
            </div>

            <div class="bg-gray-100 p-4 rounded-lg">
              <h3 class="text-lg font-semibold text-gray-900 mb-2">Za 3 ili više dana</h3>
              <span class="text-xl font-bold text-gray-900">50 - 70€ / dan</span>
            </div>
            <p class="text-gray-500 text-sm pb-3">
              *Cijene variraju ovisno o iznajmljenom vozilu
            </p>
          </div>
        </div>
      </div>
