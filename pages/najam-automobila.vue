<template>
  ...
  <Head>
    <Title>Najam automobila | Cijena 2024. | Taxi Opatija
    </Title>
    <Meta name="description" content="24/7 | Najam automobila (3+1) | Cijena | 50 - 80€ / dan | Taxi Opatija" />
  </Head>
        ...
        <div
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-gray-100 p-4 rounded-lg">
              <span class="text-xl font-bold text-gray-900">60 do 80€ / dan</span>
            </div>
            ...
            <div class="bg-gray-100 p-4 rounded-lg">
              ...
              <span class="text-xl font-bold text-gray-900">50 do 70€ / dan</span>
            </div>
          </div>
        </div>
      </div>
      <div class="flex mb-14 justify-center w-full">
        <section
          ...
          <div class="grid grid-cols-1 w-full">
            <p class="text-xs text-gray-600">*Cijene variraju ovisno o kvaliteti iznajmljenog vozila</p>
            <div class="py-0 px-4">
              <div class="flex justify-center">
                <svg class="w-32 pt-5 inline-block" viewBox="0 -100.7 404.466 404.466"
              ...
              <form action="#" class="space-y-6">
                ...
                <div class="w-full rounded-lg py-1 custom-shadow bg-gray-100">
                  <div class="flex justify-evenly items-center">
                    ...
                    <span class="text-xl font-bold text-gray-900">{{ dayPrice }} do {{ dayPrice2 }}</span>
                  </div>
                </div>
                <div>
...
const getPriceInfo = () => {
  ...
  if (dayNumber.value < 3) {
    ...
    dayPrice2.value = 80 * dayNumber.value + "€"
  } else {
    dayPrice.value = 50 * dayNumber.value;
    dayPrice2.value = 70 * dayNumber.value + "€"
  }
};
...
const generateMailtoLink = () => {
  ...
  const subject = "Upit za najam automobila";
...
const selectedItemsText = computed(() => {
  const salutation = `Poštovani, zanima me usluga najma automobila u periodu od ${format(
    date.value
  )}.\n\nMožete li mi potvrditi dostupnost automobila za to razdoblje?`;
...
useHead({
  ...
  meta: [
    ...
    { hid: "og:type", property: "og:type", content: "website" },
    {
      hid: "og:title",
      property: "og:title",
      content: "Najam automobila | Cijena 2024. | Taxi Opatija",
    },
    {
      hid: "og:description",
  ...
  script: [
    {
      ...
      innerHTML: JSON.stringify({
        ...
        "@type": "Organization",
        name: "Taxi Opatija Najam Automobila",
        url: "https://www.taxiopatija.hr/najam-automobila",
        contactPoint: {
          "@type": "ContactPoint",
...
useSeoMeta({
  title: "Najam automobila | Cijena 2024. | Taxi Opatija",
  ogTitle: "Najam automobila | Cijena 2024. | Taxi Opatija",
  description:
    "24/7 | Najam automobila (3+1) | Cijena | 50 - 80€ / dan | Taxi Opatija",
  ogDescription:
    "24/7 | Najam automobila (3+1) | Cijena | 50 - 80€ / dan | Taxi Opatija",
