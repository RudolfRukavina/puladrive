        ...
        <div class="flex items-center justify-evenly">
          <ul class="grid grid-cols-3 font-medium mt-0  text-base">
            ...
            <li class=" px-4 w-full text-center border-gray-300">
              <NuxtLink :to="{ path: '/', hash: '#prices' }" class="text-gray-900 hover:underline">{{ $t('services')
                }}
              </NuxtLink>
            </li>
      ...
      <div class="w-full mb-10 px-5 py-6 text-center">
        <div class='flex justify-center'>
          <div
            ...
            <img class="rounded-xl" src="../../assets/imgs/seastar.jpeg" alt="seastar festival logo">
...
useHead({
  title:
    "About us | Taxi Opatija | 0 - 24 | Taxi & more",
  htmlAttrs: {
    lang: "en",
  },
  meta: [
