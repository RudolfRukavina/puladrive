        ...
        <div
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-gray-100 p-4 rounded-lg">
              ...
              <span class="text-xl font-bold text-gray-900">60 - 80€ / day</span>
            </div>
            ...
            <div class="bg-gray-100 p-4 rounded-lg">
              ...
              <span class="text-xl font-bold text-gray-900">50 - 70€ / day</span>
            </div>
          </div>
        </div>
      </div>
      <div class="flex mb-14 justify-center w-full">
        <section
          ...
          <div class="grid grid-cols-1 w-full">
            <p class="text-xs text-gray-600">*The prices vary depending on the quality of the rented vehicle.</p>
            <div class="py-0 px-4">
              <div class="flex justify-center">
              ...
              <form action="#" class="space-y-6">
                ...
                <div class="w-full rounded-lg py-1 custom-shadow bg-gray-100">
                  <div class="flex justify-evenly items-center">
                    ...
                    <span class="text-xl font-bold text-gray-900">{{ dayPrice }} - {{ dayPrice2 }}</span>
                  </div>
                </div>
                <div>
...
const generateMailtoLink = () => {
  ...
  const subject = "Inquiry for car rental";
...
const selectedItemsText = computed(() => {
  const salutation = `Hello Taxi Opatija, I hope this email finds you well.\n\nI'm reaching out to inquire about the possibility of renting a car from ${format(
    date.value
  )}.\n\nCould you kindly confirm the availability of a car for this period?`;
