<template>
  ...
  <Head>
    <Title>Transfer | Venice - Opatija | Taxi Opatija | 0 - 24
    </Title>
    <Meta name="description"
      content="Transfer | Venice - Opatija | Taxi Opatija | Best service at the best price | Available 24 hours every day | Rent a car & more" />
  </Head>
      ...
      <div class="relative isolate px-6 lg:px-8">
        <div class="mx-auto max-w-2xl pt-10">
          ...
          <div class="text-center mb-6">
            ...
            <NuxtLink to="/en/places/transfer-opatija-venice" class="flex justify-center">
    ...
    <div class="leading-normal tracking-normal gradient" style="font-family: 'Source Sans Pro', sans-serif">
      ...
      <div class="flex justify-center w-full">
        <div
          ...
          <NuxtLink to="/en/places/transfer-opatija-venice"
          ...
          <h3 class="text-3xl ms-5 text-gray-900 mb-4 drop-shadow-md">
            ...
            <p class="text-gray-500 text-sm pb-3">
              Flexible transfer to Opatija from Venice
            </p>
          </h3>
      ...
      <div class="w-full flex flex-col md:flex-row py-6">
        <div class="flex-1 mb-6 text-black">
          <NuxtLink class="text-pink-600 no-underline hover:no-underline font-bold text-2xl lg:text-4xl"
            :to="{ path: '/', hash: '#home' }">alt="taxi opatija logo
            <img src="../../../assets/imgs/taxiopatijalogo.png" title="Taxi Opatija's business image, Logo"
...
const generateMailtoLink = () => {
  ...
  const subject = "Inquiry for a transfer | Venice - Opatija";
...
const selectedItemsText = computed(() => {
  const salutation = `Hello Taxi Opatija, I hope this email finds you well.\n\nI'm reaching out to inquire about your availability regarding a transfer service from Venice to Opatija on ${formatDate(date.value
...
useHead({
  title:
    "Transfer | Venice - Opatija | Taxi Opatija | 0 - 24 | Taxi & more",
  htmlAttrs: {
    lang: "en",
  },
  meta: [
