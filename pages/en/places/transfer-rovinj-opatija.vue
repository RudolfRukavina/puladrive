<template>
  ...
  <Head>
    <Title>Transfer | Rovinj - Opatija | Taxi Opatija | 0 - 24
    </Title>
    <Meta name="description"
      content="Transfer | Rovinj - Opatija | Taxi Opatija | Best service at the best price | Available 24 hours every day | Rent a car & more" />
  </Head>
      ...
      <div class="relative isolate px-6 lg:px-8">
        <div class="mx-auto max-w-2xl pt-10">
          ...
          <div class="text-center mb-6">
            ...
            <NuxtLink to="/en/places/transfer-opatija-rovinj" class="flex justify-center">
    ...
    <div class="leading-normal tracking-normal gradient" style="font-family: 'Source Sans Pro', sans-serif">
      ...
      <div class="flex justify-center w-full">
        <div
          ...
          <NuxtLink to="/en/places/transfer-opatija-rovinj"
          ...
          <h3 class="text-3xl ms-5 text-gray-900 mb-4 drop-shadow-md">
            ...
            <p class="text-gray-500 text-sm pb-3">
              Flexible transfer to Opatija from Rovinj
            </p>
          </h3>
...
const generateMailtoLink = () => {
  ...
  const subject = "Inquiry for a transfer | Rovinj - Opatija";
...
const selectedItemsText = computed(() => {
  const salutation = `Hello Taxi Opatija, I hope this email finds you well.\n\nI'm reaching out to inquire about your availability regarding a transfer service from Rovinj to Opatija on ${formatDate(date.value
...
useHead({
  title:
    "Transfer | Rovinj - Opatija | Taxi Opatija | 0 - 24 | Taxi & more",
  htmlAttrs: {
    lang: "en",
  },
  meta: [
