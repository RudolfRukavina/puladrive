<template>
  ...
  <Head>
    <Title>Rent a van | Price 2024. | Taxi Opatija
    </Title>
    <Meta name="description" content="24/7 | Rent a van (8+1) | Price | 100 - 125€ / day | Taxi Opatija" />
  </Head>
        ...
        <div
          ...
          <h3 class="text-3xl text-gray-900 mb-4 drop-shadow-md">
            ...
            <p class="text-gray-500 text-sm pb-3">
              Flexible travel across Europe
            </p>
          </h3>
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-gray-100 p-4 rounded-lg">
              <h3 class="text-lg font-semibold text-gray-900 mb-2">For 1 day</h3>
              <span class="text-xl font-bold text-gray-900">125€ / day</span>
            </div>
            ...
            <div class="bg-gray-100 p-4 rounded-lg">
              ...
              <span class="text-xl font-bold text-gray-900">120€ / day</span>
            </div>
            ...
            <div class="bg-gray-100 p-4 rounded-lg">
              ...
              <span class="text-xl font-bold text-gray-900">100€ / day</span>
            </div>
          </div>
        </div>
      </div>
      <div class="flex mb-14 justify-center w-full">
        <section
          ...
          <div class="grid grid-cols-1 w-full">
            <div class="py-0 px-4">
              <div class="flex justify-center">
                <svg class="w-32 pt-5 inline-block" version="1.1" id="_x35_" xmlns="http://www.w3.org/2000/svg"
...
const getPriceInfo = () => {
  ...
  if (dayNumber.value === 1) {
    ...
    dayPrice.value = "price per agreement"
  }
};
...
const generateVibertoLink = () => {
  const recipient = "38598491369";
  const message = selectedItemsText.value;

  const encodedMessage = encodeURIComponent(message);

  return `viber://forward?text=${encodedMessage}&recipient=${recipient}`;
};
...
const generateMailtoLink = () => {
  ...
  const subject = "Inquiry for renting a passenger van";
...
const selectedItemsText = computed(() => {
  const salutation = `Hello Taxi Opatija, I hope this email finds you well.\n\nI'm reaching out to inquire about the possibility of renting a van from ${format(
    date.value
  )}.\n\nCould you kindly confirm the availability of a van for this period?`;
  ...
  meta: [
    {
      name: "description",
      content:
        "24/7 | Rent a van (8+1) | Price | 100 - 125€ / day | Taxi Opatija",
    },
    { hid: "og:url", property: "og:url", content: "https://www.taxiopatija.hr/en/rent-a-van" },
    { hid: "og:type", property: "og:type", content: "website" },
    {
      hid: "og:title",
      property: "og:title",
      content: "Rent a van | Price 2024. | Taxi Opatija",
    },
    {
      hid: "og:description",
...
useSeoMeta({
  title: "Rent a van | Price 2024. | Taxi Opatija",
  ogTitle: "Rent a van | Price 2024. | Taxi Opatija",
  description:
    "24/7 | Rent a van (8+1) | Price | 100 - 125€ / day | Taxi Opatija",
  ogDescription:
    "24/7 | Rent a van (8+1) | Price | 100 - 125€ / day | Taxi Opatija",
