<template>
  ...
  <Head>
    <Title>Transferi | Cjenik 2024. | Taxi Opatija | 0 - 24
    </Title>
    <Meta name="description"
      content="Transferi | Cjenik 2024 | Taxi Opatija | Best service at the best price | Available 24 hours every day | Taxi & more" />
  </Head>
    ...
    <div class="leading-normal tracking-normal  gradient" style="font-family: 'Source Sans Pro', sans-serif;">
      ...
      <div class="flex justify-center w-full">
        <div class="border mx-5 max-w-lg mt-10 border-black custom-shadow rounded-lg p-6 relative bg-white pl-10">
          <svg class="w-8 mb-4 bg-red-600 rounded-tl-md rounded-br-lg p-[3px] m-1 absolute top-0 left-0 cursor-pointer"
            @click="selectedTransfer = ''" v-if="selectedTransfer" viewBox="0 0 24 24" fill="none"
          ...
          <hr />
          <div v-if="selectedTransfer" class="max-w-lg rounded-lg relative bg-white">
            <div class="mt-[15px] flex justify-between">
              ...
              <div>
                ...
                <span class="text-4xl font-bold tracking-tight text-gray-900">{{ selectedTransfer.autoCijena
                  }}€</span>
              </div>
            </div>
            <hr class="my-5" />
            <div class="flex justify-between">
              ...
              <div>
                ...
                <span class="text-4xl font-bold tracking-tight text-gray-900">{{ selectedTransfer.kombiCijena
                  }}€</span>
              </div>
            </div>
          </div>
          <div v-else>
            ...
            <div class="grid grid-cols-2 gap-4">
              <span v-for="transfer in transfersData" @click="selectedTransfer = transfer"
      ...
      <div class="flex justify-center w-full mb-14">
        <div class="border mx-5 max-w-lg mt-3 border-black custom-shadow rounded-lg p-6 relative bg-white pl-10">
          <svg class="w-8 mb-4 bg-red-600 rounded-tl-md rounded-br-lg p-[3px] m-1 absolute top-0 left-0 cursor-pointer"
            @click="selectedCityTransfer = ''" v-if="selectedCityTransfer" viewBox="0 0 24 24" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
            <g id="SVGRepo_iconCarrier">
          ...
          <hr />
          <div v-if="selectedCityTransfer" class="max-w-lg rounded-lg relative bg-white">
            <div class="mt-[15px] flex justify-between">
              <svg class="w-20 inline-block" viewBox="0 -100.7 404.466 404.466" xmlns="http://www.w3.org/2000/svg"
                fill="#000000">
                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
              ...
              <div>
                ...
                <span class="text-4xl font-bold tracking-tight text-gray-900">{{ selectedCityTransfer.autoCijena
                  }}€</span>
              </div>
            </div>
            <hr class="my-5" />
            <div class="flex justify-between">
              ...
              <div>
                ...
                <span class="text-4xl font-bold tracking-tight text-gray-900">{{ selectedCityTransfer.kombiCijena
                  }}€</span>
              </div>
            </div>
          </div>
          <div v-else>
            ...
            <div class="grid grid-cols-2 gap-4">
              <span v-for="transfer in cityTransfersData" @click="selectedCityTransfer = transfer"
                class="whitespace-nowrap rounded-full bg-sky-100 px-2.5 py-0.5 text-base text-center text-blue-600 cursor-pointer">
                {{ transfer.name }}
              </span>
            </div>
...
const cityTransfersData = ref([
  {
    name: "Poreč",
    transferTitle: "Grad Poreč",
    transferSubtitle: "Brz i udoban transfer do i od grada - Poreč.",
    autoCijena: 140,
    kombiCijena: 190,
  },
  {
    name: "Pula",
    transferTitle: "Grad Pula",
    transferSubtitle: "Brz i udoban transfer do i od grada - Pula.",
    autoCijena: 150,
    kombiCijena: 230,
  },
  {
    name: "Rovinj",
    transferTitle: "Grad Rovinj",
    transferSubtitle: "Brz i udoban transfer do i od grada - Rovinj.",
    autoCijena: 135,
    kombiCijena: 180,
  },
  {
    name: "Trst",
    transferTitle: "Grad Trst",
    transferSubtitle: "Brz i udoban transfer do i od grada - Trst.",
    autoCijena: 110,
    kombiCijena: 160,
  },
  {
    name: "Ljubljana",
    transferTitle: "Grad Ljubljana",
    transferSubtitle: "Brz i udoban transfer do i od grada - Ljubljana.",
    autoCijena: 200,
    kombiCijena: 250,
  },
  {
    name: "Plitvička jezera",
    transferTitle: "Plitvička jezera",
    transferSubtitle: "Brz i udoban transfer do i od mjesta - Plitvička jezera.",
    autoCijena: 270,
    kombiCijena: 350,
  },
  {
    name: "Postojnska jama",
    transferTitle: "Postojnska jama",
    transferSubtitle: "Brz i udoban transfer do i od mjesta - Postojnska jama.",
    autoCijena: 100,
    kombiCijena: 150,
  },
  {
    name: "Venecija",
    transferTitle: "Grad Venecija",
    transferSubtitle: "Brz i udoban transfer do i od grada - Venecija.",
    autoCijena: 300,
    kombiCijena: 350,
  },
]);
