<template>
  ...
  <Head>
    <Title>Taxi služba | Cjenik 2024. | Taxi Opatija | 0 - 24
    </Title>
    <Meta name="description"
      content="Taxi služba | Cjenik 2024 | Taxi Opatija | Best service at the best price | Available 24 hours every day | Taxi & more" />
  </Head>
  ...
  <main>
        ...
        <div class="mx-auto max-w-2xl pt-10">
          ...
          <div class="text-center mb-6">
            ...
            <h2 class="text-base font-bold tracking-tight text-gray-900">
              Cjenik 2024. - Cijena taxi službe
            </h2>
          </div>
    ...
    <div class="leading-normal tracking-normal  gradient" style="font-family: 'Source Sans Pro', sans-serif;">
      ...
      <div class="flex flex-col mx-5 md:flex-row justify-center mb-32 mt-10 md:space-x-6">
        <div class="bg-white custom-shadow  rounded-md p-6">
          <p class="text-green-700 bg-green-200 px-2.5 py-1 rounded-full inline-block mb-2">Dnevna vožnja</p>
          <h3 class="text-xl text-gray-900 mb-4">
            Usluga taxi prijevoza<br>
            <span class="font-bold text-gray-600 text-sm">05:00 - 22:00</span>
          </h3>
          <ul class="list-disc list-inside text-gray-700">
            <li class="mb-2">Početna naknada: <span class="font-bold">4.00€</span></li>
            <li class="mb-2">Po kilometru: <span class="font-bold">1.60€</span></li>
          </ul>
        </div>

        <div class="bg-white custom-shadow rounded-md p-6 mt-6 md:mt-0">
          <p class="text-red-700 bg-red-200 px-2.5 py-1 rounded-full inline-block mb-2">Noćna vožnja</p>
          <h3 class="text-xl text-gray-900 mb-4">
            Usluga taxi prijevoza<br>
          ...
          <ul class="list-disc list-inside text-gray-700">
            <li class="mb-2">Početna naknada: <span class="font-bold">4.00€</span></li>
            <li class="mb-2">Po kilometru: <span class="font-bold">2.00€</span></li>
          </ul>
        </div>
      </div>
