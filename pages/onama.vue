      ...
      <div class="relative isolate px-6 lg:px-8">
        <div class="mx-auto max-w-2xl pt-10">
          <div class="text-center">
            ...
            <h1 class="text-[56px] leading-none font-bold tracking-tight drop-shadow-md text-gray-900">
              O nama
            </h1>
            ...
            <section id="onama" class="mb-44">
                ...
                <span class="shrink-0 px-6 font-thin"><svg height='50px' width='50px' viewBox="0 0 24 24" fill="none"
                    ...
                    <g id="SVGRepo_iconCarrier">
                      ...
                      <path
                        ...
                        fill="#0F0F0F"></path>
                      <path d="M14 15C14 15.5523 14.4477 16 15 16H17C17.5523 16 18 15.5523 18 15V12H14V15Z"
                        fill="#0F0F0F"></path>
                      <path
                ...
                <span class="shrink-0 px-6 font-thin">
                  <svg width='50px' height="50px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g id="SVGRepo_iconCarrier">
                      ...
                      <path opacity="0.4" d="M12.25 10.25V11.18C12.25 11.53 12.07 11.86 11.76 12.04L11 12.5"
                        stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                        stroke-linejoin="round"></path>
                    </g>
                  </svg></span>
              ...
              <span class="flex items-center">
                <span class="h-px flex-1 bg-black"></span>
                <span class="shrink-0 px-6 font-thin">
                  <svg width='50px' height='50px' viewBox="0 -2.5 160 160" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
              ...
              <p class="text-lg mt-2 text-gray-800 mb-14">
                <span class="font-bold drop-shadow-md text-gray-800 drop-shadow-md">Hvala vam što ste odabrali Taxi
                  Opatija za vaše
                  prijevozne
