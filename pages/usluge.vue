<template>
  ...
  <Head>
    <Title>Usluge | Taxi Opatija | 0 - 24
    </Title>
    <Meta name="description"
      content="Usluge | Taxi Opatija | Best service at the best price | Available 24 hours every day | Taxi & more" />
  </Head>
  ...
  <main id='kontakt'>
    <nav
      class="bg-white flex justify-end max-w-lg overflow-x-auto text-nowrap whitespace-nowrap px-5 sticky top-0 mt-5 z-50">
