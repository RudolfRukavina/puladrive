<template>
  ...
  <Head>
    <Title>Transferi | Cjenik 2024. | Taxi Opatija
    </Title>
    <Meta name="description"
      content="24/7 | Transferi modernim putničkim kombi vozilima (8+1) & automobilima (3+1) | Cijena | 80 - 350€ | Bilo gdje u Europi | Taxi Opatija" />
  </Head>
    ...
    <div class="leading-normal tracking-normal  gradient" style="font-family: 'Source Sans Pro', sans-serif;">
      ...
      <div class="flex justify-center w-full">
        <div class="border mx-5 max-w-lg mt-10 border-black custom-shadow rounded-lg p-6 relative bg-white pl-10">
          ...
          <hr />
          <div>
            <h3 class="text-xl text-gray-900 mb-4">Izaberite aerodrom</h3>

            <div class="grid grid-cols-2 gap-4">
              <NuxtLink :to="transfer.address" v-for="transfer in transfersData" @click="selectedTransfer = transfer"
      ...
      <div class="flex justify-center w-full mb-14">
        <div class="border mx-5 max-w-lg mt-3 border-black custom-shadow rounded-lg p-6 relative bg-white pl-10">

          <h3 class="text-3xl inline-block text-gray-900 mb-2 drop-shadow-md" :class="selectedCityTransfer.transferTitle ? 'text-2xl' : 'text-3xl'
          ">
            {{
          selectedCityTransfer.transferTitle
            ? selectedCityTransfer.transferTitle
            : "Transferi"
        }}
          </h3>
          <p class="text-gray-500 text-sm pb-3">
            {{ selectedCityTransfer.transferSubtitle ? selectedCityTransfer.transferSubtitle : baseCitySubtitle }}

          </p>
          <hr />
          <div>
            <h3 class="text-xl text-gray-900 mb-4">Izaberite grad/mjesto</h3>
      ...
      <div class="w-full flex flex-col md:flex-row py-6">
        ...
        <div class="flex-1">
          ...
          $t('servicesTaxi') }}
            ...
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <NuxtLink :to="i18n.locale.value === 'en' ? '/en/transfers' : '/Transfers'"
                class="no-underline hover:underline text-gray-800 hover:text-pink-500">{{
          $t('servicesTransfers') }}
              </NuxtLink>
            </li>
...
const baseCitySubtitle = "Brzi i udobni transferi do i od gradova i mjesta: Pula, Rovinj, Poreč, Plitvička jezera, Postojnska jama, Ljubljana, Trst, Venecija."
  ...
  meta: [
    {
      name: "description",
      content:
        "24/7 | Transferi modernim putničkim kombi vozilima (8+1) & automobilima (3+1) | Cijena | 80 - 350€ | Bilo gdje u Europi | Taxi Opatija",
    },
    { hid: "og:url", property: "og:url", content: "https://www.taxiopatija.hr/transferi" },
    { hid: "og:type", property: "og:type", content: "website" },
    {
      hid: "og:title",
      property: "og:title",
      content: "Transferi | Cjenik 2024. | Taxi Opatija",
    },
    {
      hid: "og:description",
  ...
  script: [
    {
      ...
      innerHTML: JSON.stringify({
        ...
        "@type": "Organization",
        name: "Taxi Opatija Transferi",
        url: "https://www.taxiopatija.hr/transferi",
        contactPoint: {
          "@type": "ContactPoint",
...
useSeoMeta({
  title: "Transferi | Cjenik 2024. | Taxi Opatija",
  ogTitle: "Transferi | Cjenik 2024. | Taxi Opatija",
  description:
    "24/7 | Transferi modernim putničkim kombi vozilima (8+1) & automobilima (3+1) | Cijena | 80 - 350€ | Bilo gdje u Europi | Taxi Opatija",
  ogDescription:
    "24/7 | Transferi modernim putničkim kombi vozilima (8+1) & automobilima (3+1) | Cijena | 80 - 350€ | Bilo gdje u Europi | Taxi Opatija",
